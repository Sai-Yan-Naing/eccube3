...
/* nav.twig */
class __TwigTemplate_a7dce0164321482c275646f427881803e33bde51cf5f0019504546dd36eca4b8 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["level1"]) {
            if (!twig_in_filter((((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "baseUrl", array()) . "/") . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array()), "admin_route", array())) . "/") . $this->getAttribute($context["level1"], "id", array())), (isset($context["AuthorityRoles"]) ? $context["AuthorityRoles"] : null))) {
                // line 24
                echo "    <li class=\"";
                if (($this->getAttribute($this->env->getExtension('Eccube\Twig\Extension\EccubeExtension')->getActiveMenus((isset($context["menus"]) ? $context["menus"] : null)), 0, array(), "array") == $this->getAttribute($context["level1"], "id", array()))) {
                    echo "active";
                }
                echo "\">
        ";
                ...
                ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["level2"]) {
                        if (!twig_in_filter((((((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "baseUrl", array()) . "/") . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array()), "admin_route", array())) . "/") . $this->getAttribute($context["level1"], "id", array())) . "/") . $this->getAttribute($context["level2"], "id", array())), (isset($context["AuthorityRoles"]) ? $context["AuthorityRoles"] : null))) {
                            // line 33
                            echo "                    ";
                            if (($this->getAttribute($context["level2"], "url", array(), "any", true, true) && twig_in_filter($this->env->getExtension('Eccube\Twig\Extension\EccubeExtension')->getPath($this->getAttribute($context["level2"], "url", array())), (isset($context["AuthorityRoles"]) ? $context["AuthorityRoles"] : null)))) {
                                // line 34
                                echo "                    ";
                            } else {
                                // line 35
                                echo "                    <li class=\"";
                                if (($this->getAttribute($this->env->getExtension('Eccube\Twig\Extension\EccubeExtension')->getActiveMenus((isset($context["menus"]) ? $context["menus"] : null)), 1, array(), "array") == $this->getAttribute($context["level2"], "id", array()))) {
                                    echo "active";
                                }
                                echo "\">
                        ";
                            ...
                            <ul ";
                                ...
                                ";
                                    ...
                                    foreach ($context['_seq'] as $context["_key"] => $context["level3"]) {
                                        // line 43
                                        echo "                                    ";
                                        if (($this->getAttribute($context["level3"], "url", array(), "any", true, true) && twig_in_filter($this->env->getExtension('Eccube\Twig\Extension\EccubeExtension')->getPath($this->getAttribute($context["level3"], "url", array())), (isset($context["AuthorityRoles"]) ? $context["AuthorityRoles"] : null)))) {
                                            // line 44
                                            echo "                                    ";
                                        } else {
                                            // line 45
                                            echo "                                    <li class=\"";
                                            if (($this->getAttribute($this->env->getExtension('Eccube\Twig\Extension\EccubeExtension')->getActiveMenus((isset($context["menus"]) ? $context["menus"] : null)), 2, array(), "array") == $this->getAttribute($context["level3"], "id", array()))) {
                                                echo "active";
                                            }
                                            echo "\">
                                        <a href=\"";
...
";
    ...
    {
        return new Twig_Source("", "nav.twig", "E:\\webroot\\LocalUser\\eccube\\eccube3t1\\src\\Eccube\\Resource\\template\\admin\\nav.twig");
    }
}
